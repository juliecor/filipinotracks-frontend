...
export default function ChatWidget() {
  ...
  // Poll messages every 4s when chat window is open
  useEffect(() => {
  ...
  const sendMessage = async () => {
    ...
    setInput('')
    try {
      const { data } = await api.post(`/transactions/${active.transaction_id}/messages`, { body })
              ...
              {!active && (
                <>
                  <Box sx={headerSx}>
                    ...
                    {totalUnread > 0 && (
                      <Box sx={{
                        bgcolor: '#EF4444', color: 'white', borderRadius: '10px',
                        px: 0.9, py: 0.1, fontSize: '0.62rem', fontWeight: 800, mr: 1,
                      }}>
                  ...
                  <Box sx={{
                    ...
                    {conversations.length === 0 ? (
                      <Box sx={{ py: 6, textAlign: 'center' }}>
                        ...
                        <Typography variant="body2" sx={{ color: '#94A3B8', fontWeight: 600, mb: 0.3 }}>
                          No conversations yet
                        </Typography>
                        <Typography variant="caption" sx={{ color: '#CBD5E1' }}>
                          Start a chat inside a transaction
                        </Typography>
                      </Box>
                      ...
                      >
                        ...
                        <Box sx={{ flex: 1, minWidth: 0 }}>
                          ...
                          <Typography variant="body2" sx={{
                            color: conv.unread_count > 0 ? '#1E293B' : '#94A3B8',
                        ...
                        {conv.unread_count > 0 && (
                          <Box sx={{
                            width: 20, height: 20, borderRadius: '50%', bgcolor: '#EF4444',
              ...
              {active && (
                <>
                  <Box sx={headerSx}>
                    ...
                    <Avatar
                      src={active.other_avatar || undefined}
                    ...
                    <Box sx={{ flex: 1, minWidth: 0 }}>
                      ...
                      <Typography sx={{ color: 'rgba(255,255,255,0.45)', fontSize: '0.58rem', lineHeight: 1.2, overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>
                  ...
                  {/* Messages */}
                  <Box sx={{
                    height: 310, overflowY: 'auto', px: 2, py: 1.5,
                  ...
                  {/* Input */}
                  <Box sx={{ px: 1.5, py: 1.2, borderTop: '1px solid #EEF2F7', display: 'flex', gap: 0.8, alignItems: 'flex-end', bgcolor: 'white' }}>
                    <TextField
                      ...
                      sx={{
                        '& .MuiOutlinedInput-root': {
                          borderRadius: '20px', fontSize: '0.85rem', bgcolor: '#F4F6FA',
                          '& fieldset': { borderColor: 'transparent' },
                          '&:hover fieldset': { borderColor: '#E2E8F0' },
                          '&.Mui-focused fieldset': { borderColor: `${GOLD}80` },
                        },
                      }}
                    />
                    <IconButton
                      ...
                      sx={{
                        width: 36, height: 36, bgcolor: NAVY, color: 'white', flexShrink: 0,
